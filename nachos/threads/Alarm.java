...
public class Alarm {
    ...
    private class ThreadTime implements Comparable<ThreadTime> {
        ...
        /**
         * Compares object with specified object for order
         *
         * @param threadTime
         * @return 1 if current thread's waketime is greater than specified thread.
         *         -1 if current thread's waketime is less than specified thread.
         *         0 thread's waketime is equal to specified threads waittime
         */
